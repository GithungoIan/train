...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"Mombasa-Addis Ababa Express","Kampala-Nairobi Express","Nairobi-Kampala Express","Nairobi-Mombasa Express","Kisumu-Mombasa Express","Mombasa-Dodoma Express"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
void bus();//for list/routes of train
...
int main()
{
    ...
    system("cls");
    printf("\n\n\n");
   printf("====================================== WELCOME TO SGR RESERVATION SYSTEM ======================================\n\n\n");
    printf("\t\t\t\t\t[1]=> View Train List/Routes\n");
    printf("\n");
...
printf("\n\t\t\t\tThe Total booking amount is %d",1200*booking);
itoa(seat1, str1, 10);
...
printf("\n\n");
    printf("======================================================================================================\n");
 printf("\t\t\t\tYour Ksh 1200  has been Returned\t\t\t\n");
    printf("======================================================================================================\n");
}
